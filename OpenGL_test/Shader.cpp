...
void Shader::setFloat4Dyn(const std::string& name, float value1, float value2, float value3, float value4) const
{
...
void Shader::setFloat3Dyn(const std::string& name, float value1, float value2, float value3) const
{
    int vertexColorLocation = glGetUniformLocation(ID, name.c_str());
    glUseProgram(ID);
